...
public class TennisPlayer implements TennisPlayerInterface
{
    ...
    public TennisPlayer(TennisPlayer inPlayer){
        this.id = inPlayer.id;
        this.firstName = inPlayer.firstName;
        this.lastName = inPlayer.lastName;
        this.year = inPlayer.year;
        this.country = inPlayer.country;
    }
